...
# Instead, please edit 06-data-transformation.md in _episodes_rmd/
...
# … with 10 more variables: reference Bases <dbl>, Theta <dbl>, Pi <dbl>,
#   Heterozygosity <dbl>, percent.GC <dbl>, Recombination <dbl>,
#   Divergence <dbl>, Constraint <dbl>, SNPs <dbl>, GC.binned <fct>
~~~
{: .output}
...
~~~
Error in knitr::include_graphics("../images/transform-logical.png"): Cannot find the file(s): "../images/transform-logical.png"
~~~
{: .error}
...
# … with 59,130 more rows, and 12 more variables: reference Bases <dbl>,
#   Theta <dbl>, Pi <dbl>, Heterozygosity <dbl>, percent.GC <dbl>,
#   Recombination <dbl>, Divergence <dbl>, Constraint <dbl>, SNPs <dbl>,
