...
# Data visualization
<img src="../img/ggplot2.png" align="right" hspace="10">
## Introduction

> "The simple graph has brought more information to the data analyst’s mind 
> than any other device." --- John Tukey

In this lesson we will learn how to visualize your data using [ggplot2](https://ggplot2.tidyverse.org/). 
...
The lesson is based on Chapter 8 of the [Bioinformatics Data Skills](BDS) book 
by Vince Buffalo and Chapter 2 of the [R for Data Science](https://r4ds.had.co.nz/) 
book by Garrett Grolemund and Hadley Wickham.

### Additional Resources

- Download the [ggplot2 cheatsheet](https://github.com/rstudio/cheatsheets/raw/master/data-visualization-2.1.pdf)
  and keep it handy while you are working with the package.
- See the [official ggplot2 page](https://ggplot2.tidyverse.org/) for additional 
  resources (including free books).
...
Notice the missing diversity estimates in the middle of this plot. What’s going 
on in this region? We can explore this question easily in ggplot by mapping a 
possible confounder or explanatory variable to another aesthetic. In this case, 
let’s map the color aesthetic of our point geometric objects to the column cent, 
...
> You can map any of the geometric objects’ 
> aesthetics to columns in your dataframe.
...
Now we'll return for a minute to data manipulation and create a new tbl by 
merging two additional datasets available in Buffalo's 
bds-files GitHub repository for chapter 8. We start by reading these datasets 
with `read_tsv`:
...
These two datasets come from a study that explored recombination rates around a 
degenerate sequence motif that is common in some repeat classes.
The first dataset contains estimates of the recombination rate for all windows 
within 40kb of each of the two motif variants. The second dataset contains info 
about repeats each motif occur in. Our goal will be to merge these two 
...
Watch for the transition from `%>%` to `+`. This transition is necessary because 
